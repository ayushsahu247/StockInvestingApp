...
def portfolio(request):
	...
	if market_open():
		stocks = { investment : nse.get_stock_quote(investment.stock.symbol)['lastPrice'] for investment in investments}  #this dictionary then has
	...
	return render(request, 'portfolio.html', {'investments':stocks, 'investor':Investor(user_id=request.user.id) }) 
...
def notifications(request):
	...
	return render(request, 'notifications.html', {'records':records})